                  ...
                  foreach($uploads as $uploads){
                   ...
                   if(in_array($firstChar, $forbiddenChars)){
                    continue;
                      ...
                      echo '<div class="row" style="text-align:left; padding:10px">
                      <div class="column">
                      <a style="color:#FFFF00">Risk Assessment</a><br><br>
                      <a href="../../member/clients/'.$custBsid.'_'.$custBs.'/safety/risk_assess/'.$uploads.'" target="_blank" rel="noopener noreferrer"><button class="btn9 vda"><i style="font-size:15px" class="far fa-arrow-alt-circle-down"></i> Download</button></a>
                      </div>
                      <div class="column">
                      <a style="color:#FFFF00">Last Review</a><br><br>
                      <a style="color:white">01/12/2345</a>
                      </div>
                      </div>
                      ';
                  }
