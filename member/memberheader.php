    ...
    <div class="container">
      ...
      <div class="row">
          <div class="column-33" style="text-align:centre">
              <a href="/member/member.php?usid=<?php echo $usid ?>&bsid=<?php echo $bsid ?>"><img src="/design/images/new_arc_logo.png" style="height:80px"></a>
          </div>
        ...
        <?php
            if (isset($_SESSION['email'])) {
                ...
                echo '<p style="color:white">You are logged in as <a style="color:white"><b><u>'.$_SESSION['email'].'</u></b></a></p>
                        <a href="/member/includes/logoutus.inc.php"><button class="btn7 lnk"><b><u>Logout</b></u></button></a></p>';
            }
            else {
