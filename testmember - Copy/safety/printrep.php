...
<div class="row">
      ...
      <div class="modcontainer">
        ...
        <div class="mod" style="border:2px solid #FFFF00; border-radius:10px; padding:10px">
                  ...
                  <label style="color:white">A <?php echo $eliCom ?></label><br>
                  ...
                  <label style="color:#FFFF00">Additional comments</label><br>
                  <label style="color:white">A <?php echo $pliCom ?></label><br>
                  ...
                  <label style="color:#FFFF00">Additional comments</label><br>
                  <label style="color:white">A <?php echo $rriCom ?></label><br>
                  ...
                  <label style="color:#FFFF00">Additional comments</label><br>
                  <label style="color:white">A <?php echo $airCom ?></label><br>
      </div><br>
