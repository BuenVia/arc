...
<div class="mod" style="border:2px solid #FFFF00; border-radius:10px; padding:10px">
          <h2 style="color:#FFFF00"><i class="far fa-file-alt"></i></i> <b>6. Training</b></h1>
            <label style="color:#FFFF00">6.1 All staff have been trained in fire safety and training documented?</label><br>
            <label style="color:white">A <?php echo $fireTrain ?></label><br>
            <label style="color:#FFFF00">6.2 All staff have been trained in general safety and training documented?</label><br>
            <label style="color:white">A <?php echo $genTrain ?></label><br>
            <label style="color:#FFFF00">6.3 All staff have been trained in using equipment correctly and training documented?</label><br>
...
<div class="mod" style="border:2px solid #FFFF00; border-radius:10px; padding:10px">
            ...
            <label style="color:#FFFF00">9.1 Are walkways highlighted and kept clear of obstruction?</label><br>
            <label style="color:white">A <?php echo $wsWalk ?></label><br>

            <label style="color:#FFFF00">9.2 Are all access and egress points kept free of obstruction?</label><br>
            <label style="color:white">A <?php echo $wsEgr ?></label><br>

            <label style="color:#FFFF00">9.3 Suitable racking and shelving is used?</label><br>
            <label style="color:white">A <?php echo $wsRack ?></label><br>

            <label style="color:#FFFF00">9.4 All items are easily accessible, with suitable ladders provided where needed?</label><br>
            <label style="color:white">A <?php echo $wsAcs ?></label><br>

            <label style="color:#FFFF00">9.5 Any ladders used are in good condition?</label><br>
            <label style="color:white">A <?php echo $wsLad ?></label><br>

            <label style="color:#FFFF00">9.6 Is all welding performed in a designated area?</label><br>
            <label style="color:white">A <?php echo $wsWeld ?></label><br>

            <label style="color:#FFFF00">9.7 Does welding equipment appear to be in good condition?</label><br>
            <label style="color:white">A <?php echo $wsWeldEquip ?></label><br>

            <label style="color:#FFFF00">9.8 Is suitable PPE provided for welding?</label><br>
            <label style="color:white">A <?php echo $wsWeldPPE ?></label><br>

            <label style="color:#FFFF00">9.9 Does all sanding and grinding equipment appear to be in good condition?</label><br>
            <label style="color:white">A <?php echo $wsSand ?></label><br>

            <label style="color:#FFFF00">9.10 Is battery charging performed in a safe and secure location, free from any unnessecary risks?</label><br>
            <label style="color:white">A <?php echo $wsBat ?></label><br>

            <label style="color:#FFFF00">9.11 Is wheel changing performed in a safe and secure location, free from any unnessecary risks?</label><br>
            <label style="color:white">A <?php echo $wsWheel ?></label><br>

            <label style="color:#FFFF00">9.12 List types of lifting equipment used.</label><br>
            <label style="color:white">A <?php echo $wsLift ?></label><br>

            <label style="color:#FFFF00">9.13 Is all lifting equipment in good condition?</label><br>
            <label style="color:white">A <?php echo $wsLiftCond ?></label><br>

            <label style="color:#FFFF00">9.14 Is workshop suitably lit?</label><br>
            <label style="color:white">A <?php echo $wsLit ?></label><br>

            <label style="color:#FFFF00">9.15 Is workshop suitably clean, tidy and organised?</label><br>
            <label style="color:white">A <?php echo $wsTidy ?></label><br>

            <label style="color:#FFFF00">Additional Comments.</label><br>
            <label style="color:white">A <?php echo $wsCom ?></label><br>
</div><br>
