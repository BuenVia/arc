    ...
    <div class="mod" style="border:2px solid #FFFF00; border-radius:10px; padding:10px">
        <div class="modhead" style="text-align:center">
          ...
          <div class="modcontainer">
            ...
            <label style="color:white">6.1 All staff have been trained in fire safety?</label><br>
            ...
            <label style="color:white">6.2 All staff have been trained in general safety?</label><br>
            ...
            <label style="color:white">6.3 All staff have been trained in using equipment correctly?</label><br>
